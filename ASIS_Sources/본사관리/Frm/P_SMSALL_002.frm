...
Begin VB.Form P_SMSALL_2 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      BorderStyle     =   1
      PaneTree        =   "P_SMSALL_002.frx":0E95
      Begin FPSpreadADO.fpSpread spdView 
         ...
         ScrollBars      =   2
         SpreadDesigner  =   "P_SMSALL_002.frx":0FC7
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdView 
         ...
         RetainSelBlock  =   0   'False
         ScrollBars      =   0
         SpreadDesigner  =   "P_SMSALL_002.frx":15DE
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   6
         SpreadDesigner  =   "P_SMSALL_002.frx":1B40
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         PictureBackground=   "P_SMSALL_002.frx":217F
         BevelOuter      =   0
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      End
      Begin Threed.SSPanel SSPanel1 
         ...
         Caption         =   "전송일자"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_SMSALL_002.frx":25E1
         BevelOuter      =   0
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      End
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackgroundStyle=   2
         PictureBackground=   "P_SMSALL_002.frx":2A43
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_SMSALL_002.frx":2C45
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Caption         =   "가맹점별 전송내역"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_SMSALL_002.frx":5B17
         BevelOuter      =   0
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      End
...
Private Sub Data_Display()
    ...
    With spdView(0)
        ...
        Do Until RS01.EOF
            ...
            .Col = 1: .Text = RS01!코드 & ""
            .Col = 2: .Text = RS01!체인점명 & ""
            .Col = 3: .Text = RS01!전송수량 & ""
            .Col = 4: .Text = RS01!잔여수량 & ""
