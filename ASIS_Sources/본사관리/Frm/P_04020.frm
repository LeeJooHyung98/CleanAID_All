...
Begin VB.Form P_04020 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_04020.frx":063C
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_04020.frx":083E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   20
         SpreadDesigner  =   "P_04020.frx":3CAA
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_04020"
...
Private Sub Data_Display()
    ...
    sValue(2) = Format(dtInput(0).Value, "YYMMDD")
    sValue(3) = Format(dtInput(1).Value, "YYMMDD")
    
    If HeadOffice = MASTER_OFFICE_CODE Then
        If DBOpen_Master(Mid(cboOffice.Text, 2, 4)) = False Then Exit Sub
        
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecProMaster("SP_04020_00", sValue(), Err_Num, Err_Dec)
    Else
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecPro("SP_04020_00", sValue(), Err_Num, Err_Dec)
    End If
    ...
    With spdView
        ...
        Do Until RS01.EOF
            ...
            If Left(RS01!메시지2, 2) = "OK" Then
                .Col = 3: .Text = "승인": .ForeColor = vbBlue
            
                nCnt = nCnt + 1
                dblTotal = dblTotal + Val(RS01!결제금액 & "")
            Else
                .Col = 3: .Text = "취소": .ForeColor = vbRed
            End If
            
            .Col = 4:  .Text = RS01!성명 & ""               '
            .Col = 5:  .Text = RS01!전화번호 & ""           '
            .Col = 6:  .Text = RS01!휴대전화 & ""           '
            .Col = 7:  .Text = RS01!접수번호 & ""           '
            .Col = 8:  .Text = RS01!승인번호 & ""           '
            .Col = 9:  .Text = RS01!승인일자 & ""           '
            .Col = 10: .Text = RS01!승인시간 & ""           '
            .Col = 11: .Text = RS01!할부기간 & ""           '
            .Col = 12: .Text = RS01!결제금액 & ""           '
            .Col = 13: .Text = RS01!발급사코드 & ""         '
            .Col = 14: .Text = RS01!카드종류명 & ""         '
            .Col = 15: .Text = RS01!매입사코드 & ""         '
            .Col = 16: .Text = RS01!매입사명 & ""           '
            .Col = 17: .Text = RS01!카드번호 & "" '
            .Col = 18: .Text = RS01!메시지1 & ""            '
            .Col = 19: .Text = RS01!메시지2 & ""            '
            .Col = 20: .Text = RS01!고객코드 & ""           '
