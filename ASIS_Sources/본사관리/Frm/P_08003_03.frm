...
Begin VB.Form P_08003_03 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_08003_03.frx":05DC
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_08003_03"
...
Private Sub DataSave()
    ...
    For i = 1 To spdView.MaxRows
        ...
        sDownPath = P_08003.txtInput(0).Text
        ...
        If spdView.Value = True Then
            ...
            Open sDownPath & "\Sale" & sValue(2) & ".Dat" For Output As #hFile
