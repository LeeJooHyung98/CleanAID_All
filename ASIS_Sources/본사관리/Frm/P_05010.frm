...
Begin VB.Form P_05010 
   Caption         =   "보관 서비스 접수 현황"
   ClientHeight    =   12405
   ClientLeft      =   1545
   ClientTop       =   3585
   ClientWidth     =   17655
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_05010.frx":05DC
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_05010"
...
'    pnlHeader.Caption = " " & Me.Caption & " (" & Me.Name & ")"
    ...
    If P_05010_Flag = False Then
        ...
        Set RS01 = ExecPro("SP_05010_01", sValue(), Err_Num, Err_Dec)
