...
Begin VB.Form P_08003_05 
   BorderStyle     =   1  '단일 고정
   Caption         =   "보관 서비스 가격 생성"
   ClientHeight    =   8055
   ClientLeft      =   4080
   ClientTop       =   5640
   ClientWidth     =   8445
   Icon            =   "P_08003_05.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_08003_05.frx":05DC
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_08003_05"
...
Private Sub DataSave()
    ...
    For i = 1 To spdView.MaxRows
        ...
        If spdView.Value = True Then
            ...
            Set RS01 = ExecPro("SP_08003_03", sValue(), Err_Num, Err_Dec)
            
            Do While Not RS01.EOF
                sData = RS01!보관월 & "|" & RS01!아이템수 & "|" & RS01!보관개월수 & "|" & RS01!보관가격
                Print #1, sData
...
Private Sub Data_Display()
    ...
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_08003_02", sValue(), Err_Num, Err_Dec)
