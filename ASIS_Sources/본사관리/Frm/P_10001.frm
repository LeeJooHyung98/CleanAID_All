...
Begin VB.Form P_10001 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_10001.frx":063C
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_10001.frx":083E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   35
         ScrollBars      =   2
         SpreadDesigner  =   "P_10001.frx":3710
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdView1 
         ...
         GridSolid       =   0   'False
         MaxCols         =   16
         SpreadDesigner  =   "P_10001.frx":3C8C
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
...
Private Sub cmdBtn_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 6: Call Export_Excel(P_00000.cdgExcel, spdView1)
        Case 7: Unload Me           ' 종료
    End Select
