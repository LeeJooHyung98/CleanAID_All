...
Begin VB.Form P_04035 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxCols         =   15
         MaxRows         =   10
         SpreadDesigner  =   "P_04035.frx":061C
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel panInput 
         ...
         Begin Threed.SSPanel panCaption 
            ...
            RoundedCorners  =   0   'False
         End
         Begin XtremeSuiteControls.CheckBox chkStore 
            Height          =   285
            Left            =   4740
            TabIndex        =   19
            Top             =   420
         ...
         Begin Threed.SSPanel panCaption 
            ...
            _ExtentY        =   556
            _Version        =   262144
            Caption         =   "(지사 이동이 있을 경우 이전 지사의 매출 포함)"
            BevelOuter      =   0
            RoundedCorners  =   0   'False
         End
      End
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_04035.frx":10C6
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_04035.frx":12C8
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin XtremeSuiteControls.PushButton cmdBtn 
            ...
            Enabled         =   0   'False
            Appearance      =   6
            Picture         =   "P_04035.frx":3C00
         End
      End
   End
End
Attribute VB_Name = "P_04035"
...
'        .TypeHAlign = TypeHAlignLeft
    ...
    chkStore.BackColor = panInput.BackColor
...
Private Sub Data_Display()
    ...
    sValue(0) = Mid(cboOffice.Text, 2, 4):          If sValue(0) = "0000" Then sValue(0) = "%"
    sValue(1) = Mid(cboInput.Text, 2, 6):           If sValue(1) = "000000" Then sValue(1) = "%"
    sValue(2) = Format(dtInput(0).Value, "yyyy")
    
    Set RS01 = New ADODB.Recordset
    
    If chkStore.Value = xtpChecked Then
        Set RS01 = ExecPro("SP_04035_01", sValue(), Err_Num, Err_Dec)
    Else
        Set RS01 = ExecPro("SP_04035_00", sValue(), Err_Num, Err_Dec)
    End If
    spdView.MaxRows = 0
