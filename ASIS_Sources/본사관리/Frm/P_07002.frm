...
Begin VB.Form P_07002 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_07002.frx":067C
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07002.frx":087E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   35
         ScrollBars      =   2
         SpreadDesigner  =   "P_07002.frx":3750
         UserResize      =   1
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel SSPanel 
         ...
         Caption         =   " 지사 외주 현황"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07002.frx":3D82
         Alignment       =   1
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      ...
      Begin XtremeSuiteControls.TabControl TabControl 
         ...
         Begin XtremeSuiteControls.TabControlPage TabControlPage 
            ...
            Begin FPSpreadADO.fpSpread spdViewScan 
               ...
               MaxRows         =   35
               ScrollBars      =   0
               SpreadDesigner  =   "P_07002.frx":41E4
               UserResize      =   1
               Appearance      =   1
               HighlightHeaders=   1
               HighlightStyle  =   1
...
Private Sub Data_Update()
    ...
    If IsNumeric(panCaption(1).Tag) = False Then
        Call SetOutCnt
    End If
...
Private Sub SetOutCnt()
    ReDim sValue(0)
    sValue(0) = Format(dtInput(0).Value, "yyyyMMdd")
    Set RS01 = New ADODB.Recordset
