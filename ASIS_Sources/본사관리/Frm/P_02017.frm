...
Begin VB.Form P_02017 
   Caption         =   "가맹점 접수현황 - 오점사진보기"
   ClientHeight    =   9750
   ClientLeft      =   2700
   ClientTop       =   1920
   ClientWidth     =   16860
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel panInput 
         ...
         Begin VB.ComboBox cboGubun 
            Height          =   315
            ItemData        =   "P_02017.frx":061C
            Left            =   6525
            List            =   "P_02017.frx":061E
            Style           =   2  '드롭다운 목록
            TabIndex        =   21
            Top             =   405
            Width           =   1425
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   " 가맹점 접수현황 - 오점사진보기 (P_02017)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_02017.frx":0BBA
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_02017.frx":0DBC
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxCols         =   24
         Protect         =   0   'False
         SpreadDesigner  =   "P_02017.frx":3C8E
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_02017"
...
Private Sub Data_Display()
    ...
    If HeadOffice = MASTER_OFFICE_CODE Then
        ...
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecProMaster("SP_02017_00", sValue(), Err_Num, Err_Dec)
    Else
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecPro("SP_02017_00", sValue(), Err_Num, Err_Dec)
    End If
    ...
    With spdView
        ...
        Do Until RS01.EOF
            ...
            .Col = 2:  .Text = RS01!의류코드 & ""                       ' 2
            .Col = 3:  .Text = RS01!의류명 & ""                         ' 3
            
            If (Trim(RS01!오점이미지) = "") Or (IsNull(RS01!오점이미지)) Then
                .Col = 4: .TypePictPicture = LoadPicture()              ' 4
            Else
                ...
                .Col = 4: .TypePictPicture = LoadPicture(AppPath & "Temp.JPG") ' 5
            End If
            
            .Col = 5:  .Text = RS01!오점내용 & ""       ' 6
            .Col = 6:  .Text = RS01!색상 & ""           ' 7
            .Col = 7:  .Text = RS01!내용 & ""           ' 8
            .Col = 8:  .Text = RS01!상표 & ""           ' 9
            .Col = 9:  .Text = RS01!금액 & ""           '10
            .Col = 10: .Text = RS01!접수번호 & ""       '11
            .Col = 11: .Text = RS01!성명 & ""           '12
            .Col = 12: .Text = RS01!전화번호 & ""       '13
            .Col = 13: .Text = RS01!휴대전화 & ""       '14
            .Col = 14: .Text = RS01!접수일자 & ""       '15
            .Col = 15: .Text = RS01!가맹점출고일자 & "" '16
            .Col = 16: .Text = RS01!가맹점입고일자 & "" '17
            .Col = 17: .Text = RS01!지사입고일자 & ""   '18
            .Col = 18: .Text = RS01!지사출고일자 & ""   '19
            .Col = 19: .Text = RS01!출고일자 & ""       '20
            .Col = 20: .Text = RS01!부모택번호 & ""     '21
            .Col = 21: .Text = RS01!반품환불일자 & ""   '22
            .Col = 22: .Text = RS01!세탁환불일자 & ""   '23
            .Col = 23: .Text = RS01!판매취소일자 & ""   '24
            .Col = 24: .Text = RS01!환불사유 & ""       '25
