   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   " 가맹점 품목할인 현황 (P_01004)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01004.frx":069C
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01004.frx":089E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         Protect         =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "P_01004.frx":3770
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdList 
         ...
         Protect         =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "P_01004.frx":3C90
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel panCaption 
         ...
         Caption         =   " 가맹점 품목할인 현황"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01004.frx":428F
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      End
      Begin FPSpreadADO.fpSpread sprClass 
         ...
         MaxCols         =   2
         ScrollBars      =   2
         SpreadDesigner  =   "P_01004.frx":46F1
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdView2 
         ...
         MaxCols         =   6
         ScrollBars      =   2
         SpreadDesigner  =   "P_01004.frx":4C13
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_01004"
