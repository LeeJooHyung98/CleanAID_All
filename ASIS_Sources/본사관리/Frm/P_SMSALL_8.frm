...
Begin VB.Form P_SMSALL_8 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         ScrollBars      =   2
         SpreadDesigner  =   "P_SMSALL_8.frx":065C
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   " SMS 발송 현황 (P_SMSALL_8)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_SMSALL_8.frx":0BF7
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_SMSALL_8.frx":0DF9
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel1 
         ...
         Caption         =   "가맹점별 전송내역"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_SMSALL_8.frx":3CCB
         BevelOuter      =   0
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      End
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   2
         SpreadDesigner  =   "P_SMSALL_8.frx":412D
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_SMSALL_8"
...
Private Sub Data_Display()
    ...
    Set RS01 = ExecPro("SP_M_SMSALL_008_01", sValue(), Err_Num, Err_Dec)
...
Private Sub Form_Activate()
    ...
    For nRow = 1 To spdView(2).MaxRows
        If nRow >= 100 Then Exit Sub
        
        spdView(2).SetText 1, nRow, CVar("[크린에이드] 이마트 20주년 세탁30%할인(일부품목제외) 10/31~11/13")
        spdView(2).SetText 2, nRow, CVar("발송완료")
    Next nRow
End Sub
...
'    spdView(1).Col = 1:  sValue(2) = Format(spdView(1).Text, "YYYY-MM-DD")
'
'    Set RS01 = New ADODB.Recordset
...
'            .Col = 2: .Text = RS01!고객성명 & ""
'            .Col = 3: .Text = RS01!전화번호 & ""
'            .Col = 4: .Text = RS01!전송시간 & ""
'            .Col = 5: .Text = RS01!메시지 & ""
'            .Col = 6: .Text = RS01!상태 & ""
'
'            RS01.MoveNext
