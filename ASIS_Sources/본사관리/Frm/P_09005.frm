...
Begin VB.Form P_09005 
   Caption         =   "[전사업장]송신 메일 관리"
   ClientHeight    =   11790
   ClientLeft      =   1575
   ClientTop       =   2760
   ClientWidth     =   17520
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   7
         SpreadDesigner  =   "P_09005.frx":063C
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   " 송신 메일 관리 (P_09005)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_09005.frx":0DC3
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_09005.frx":0FC5
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin XtremeSuiteControls.PushButton cmdBtn 
            ...
            Enabled         =   0   'False
            Appearance      =   6
            Picture         =   "P_09005.frx":38FD
         End
      End
   End
End
Attribute VB_Name = "P_09005"
...
Private Sub Form_Activate()
    ...
    If P_09005_Flag = False Then
        ...
        If HeadOffice = MASTER_OFFICE_CODE Then
            ...
            Set RS01 = ExecPro("SP_M_09005_01", sValue(), Err_Num, Err_Dec)
        Else
            
            If DBOpen_Master(MASTER_OFFICE_CODE) = False Then Exit Sub
            
            Set RS01 = New ADODB.Recordset
            Set RS01 = ExecProMaster("SP_M_09005_01", sValue(), Err_Num, Err_Dec)
        End If
        ...
        With spdView
            ...
            Do Until RS01.EOF
                ...
                .Col = 1: .Text = RS01!송신일자 & ""
                .Col = 2: .Text = RS01!문서번호 & ""
                .Col = 3: .Text = RS01!대리점명 & ""
                .Col = 4: .Text = RS01!전송여부 & ""
                .Col = 5: .Text = RS01!수신여부 & ""
                .Col = 6: .Text = RS01!수신일자 & ""
                .Col = 7: .Text = RS01!파일명 & ""
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Call SubBottonEnable(cmdBtn, "00000001")
...
Private Sub spdView_Click(ByVal Col As Long, ByVal Row As Long)
    ...
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_M_09005_00", sValue(), Err_Num, Err_Dec)
    
    spdView.Col = 7
    If Len(spdView.Text) <= 0 Then
        rtbInput.Text = RS01!공지내역 & ""
        txtTitle.Text = ""
    Else
        txtTitle.Text = RS01!공지내역 & ""
    
        ' 작성일자, 문서번호
        Call DataPCSaveFile(sValue(1), sValue(2))
    End If
...
Private Sub DataPCSaveFile(sDate As String, sDocNum As String)
    ...
    rtbInput.LoadFile sFileFullName, rtfRTF
