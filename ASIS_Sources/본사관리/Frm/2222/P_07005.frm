...
Begin VB.Form P_07005 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_07005.frx":00D2
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07005.frx":02D4
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   35
         ScrollBars      =   2
         SpreadDesigner  =   "P_07005.frx":31A6
         UserResize      =   1
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel SSPanel 
         ...
         Caption         =   " 지사 외주 현황"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07005.frx":37B5
         Alignment       =   1
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      ...
      Begin FPSpreadADO.fpSpread spdViewScan 
         ...
         MaxRows         =   35
         ScrollBars      =   0
         SpreadDesigner  =   "P_07005.frx":3C17
         UserResize      =   1
         Appearance      =   1
         HighlightHeaders=   1
         HighlightStyle  =   1
...
Private Sub Data_Display2()
    ...
    With spdViewScan
        ...
        Do Until RS01.EOF
            ...
            .Col = 3: .Text = RS01!의류명 & ""    '
            .Col = 4: .Text = Format(RS01!출고일자 & "", "@@@@-@@-@@")   '
            .Col = 5: .Text = RS01!회차 & ""    '
            .Col = 6: .Text = Format(RS01!입고일자 & "", "@@@@-@@-@@")   '
            .Col = 7: .Text = RS01!OUTSCANDT & ""      'PDA 스켄일자
            .Col = 8: .Text = RS01!OUTPDANO & ""       'PDA NO
            RS01.MoveNext
        Loop
        RS01.Close
        Set RS01 = Nothing
