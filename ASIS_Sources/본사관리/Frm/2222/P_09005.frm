...
Begin VB.Form P_09005 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_09005.frx":00B2
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_09005.frx":0628
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_09005.frx":082A
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
...
Private Sub cboInput_Click(Index As Integer)
    ...
    If Index = 1 Then
        ...
        Call StoreComboAdd(cboInput(0), sCode)
    End If
...
Private Sub Form_Activate()
    ...
    If P_09005_Flag = False Then
        ...
        Call StoreComboAdd(cboInput(0), Trim(Mid(Trim(cboInput(1)) & Space(10), 2, 4)))
