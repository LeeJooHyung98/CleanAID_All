...
Begin VB.Form P_07012 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_07012.frx":00F2
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07012.frx":02F4
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Caption         =   " 지사 외주 현황"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07012.frx":31C6
         Alignment       =   1
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      ...
      Begin XtremeSuiteControls.TabControl TabControl 
         ...
         Begin XtremeSuiteControls.TabControlPage TabControlPage 
            ...
            Begin FPSpreadADO.fpSpread spdViewScan 
               ...
               MaxRows         =   35
               ScrollBars      =   0
               SpreadDesigner  =   "P_07012.frx":3628
               UserResize      =   1
               Appearance      =   1
               HighlightHeaders=   1
               HighlightStyle  =   1
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   35
         ScrollBars      =   2
         SpreadDesigner  =   "P_07012.frx":43C7
         UserResize      =   1
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
...
Private Sub Data_Update()
    ...
    '------------------------------------------------------------
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_M_07012_03", sValue(), Err_Num, Err_Dec)
    ...
    Do While Not RS01.EOF
        ...
        Call ExecPro("SP_M_07012_02", sValue(), Err_Num, Err_Dec)
        If Err_Num <> 0 Then
            MyCon.RollbackTrans
            MsgBox Err_Dec
            Exit Sub
...
'    spdView.Col = 1: 가맹점코드 = spdView.Text & ""
    ...
    With spdViewScan
        ...
        For nRow = 1 To .MaxRows
            ...
            .Col = 5: sValue(2) = .Text & ""        ' INDATE
            .Col = 10: sValue(3) = panCaption(1).Tag & ""         ' ICNT
            .Col = 1: sValue(4) = .Text & ""        ' TAGNO
            
            .Col = 2: sValue(5) = .Text & ""        ' IGCODE
            .Col = 3: sValue(6) = .Text & ""        ' IGDNM
            .Col = 4: sValue(7) = .Value & ""         ' IPRICE
            .Col = 6: sValue(8) = .Text & ""        ' SCANDT
            .Col = 7: sValue(9) = .Text & ""        ' PDANO
            .Col = 11: sValue(10) = .Text & ""      ' ADDTYPE
            .Col = 1: sValue(11) = Format(dtInput(1).Value, "yyyy-MM-dd") & ""       ' INACTIONDATE
