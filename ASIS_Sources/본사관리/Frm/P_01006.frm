...
Begin VB.Form P_01006 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_01006.frx":05FC
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_01006.frx":0A96
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01006.frx":0C98
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin XtremeSuiteControls.PushButton cmdBtn 
            ...
            Enabled         =   0   'False
            Appearance      =   6
            Picture         =   "P_01006.frx":35D0
         End
      End
   End
End
Attribute VB_Name = "P_01006"
...
'    If P_01006_Flag = False Then
'        ReDim sValue(1)
'
'        sValue(0) = "1"
'
'        Set RS01 = New ADODB.Recordset
'        Set RS01 = ExecPro("SP_01006_00", sValue(), Err_Num, Err_Dec)
'
...
Public Sub DataSave()
    ...
    For i = 1 To spdView.MaxRows
        ...
        Call ExecPro("SP_01006_01", sValue(), Err_Num, Err_Dec)
    Next i
...
Public Sub DataDelete()
    If MsgBox("해당되는 데이터를 삭제하시겠습니까?", vbYesNo + vbInformation + vbDefaultButton2, "데이터 삭제") = vbYes Then
        ...
        Call ExecPro("SP_01006_02", sValue(), Err_Num, Err_Dec)
