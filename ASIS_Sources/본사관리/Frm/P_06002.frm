...
Begin VB.Form P_06002 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_06002.frx":063C
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_06002.frx":0AD6
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_06002.frx":0CD8
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
...
Private Sub Form_Load()
    ...
    If P_06002_Flag = False Then
        ...
        spdView.MaxRows = 0 'RS01.RecordCount
...
Private Sub Data_Display()
    ...
    sValue(10) = Mid(Trim(cboInput(5).Text), 2, 4) & "%"
...
Private Sub spdView_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    spdView.GetText 2, Row, vText
    If Len(vText) = 6 Then
        spdView.GetText 4, Row, vText
        P_06001.sCodeKey = CStr(vText) & " / "
        
        spdView.GetText 1, Row, vText
        P_06001.sCodeKey = P_06001.sCodeKey & CStr(vText) & " / "
        
        spdView.GetText 2, Row, vText
        P_06001.sCodeKey = P_06001.sCodeKey & "[" & CStr(vText) & "]"
        
        P_06001.SetFocus
        P_06001.Data_Display
