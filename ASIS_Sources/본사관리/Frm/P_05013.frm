...
Begin VB.Form P_05013 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   37
         ScrollBars      =   2
         SpreadDesigner  =   "P_05013.frx":063C
         UserResize      =   1
         ScrollBarTrack  =   2
         HighlightHeaders=   1
         HighlightStyle  =   1
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   37
         ScrollBars      =   2
         SpreadDesigner  =   "P_05013.frx":0B96
         UserResize      =   1
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   37
         ScrollBars      =   0
         SpreadDesigner  =   "P_05013.frx":10DC
         UserResize      =   1
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   " 쿠폰 사용 현황 (P_05013)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_05013.frx":15F9
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
...
Private Sub Data_Display()
    ...
    For i = 0 To spdView.Count - 1
        For j = 1 To spdView(i).MaxRows
            ...
            spdView(i).Col = 1: spdView(i).Text = ""
            spdView(i).Col = 2: spdView(i).Text = ""
            spdView(i).Col = 3: spdView(i).Text = ""
        Next j
    Next i
    
    sValue(0) = "0"
    sValue(1) = Format(dtInput(0).Value, "yyyymm")
    sValue(2) = Left(cboInput(0).Text, 2)
    
    
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_05013_01", sValue(), Err_Num, Err_Dec)
    ...
    Do While Not RS01.EOF
        ...
        spdView(0).Row = j
        spdView(0).Col = 1: spdView(0).Text = RS01!지사코드 & ""
        spdView(0).Col = 2: spdView(0).Text = RS01!지사명 & ""
        spdView(0).Col = 3: spdView(0).Text = RS01!수량 & ""
...
Public Sub Data_Display2()
    ...
    sValue(3) = Left(cboInput(0).Text, 2)
    
    
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_05013_02", sValue(), Err_Num, Err_Dec)
    ...
    Do While Not RS01.EOF
        ...
        spdView(1).Col = 1
        spdView(1).Text = RS01!코드 & ""
        spdView(1).Col = 2
        spdView(1).Text = RS01!대리점명 & ""
        spdView(1).Col = 3
...
ERR_RTN:
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure Data_Display of Form P_05013"
...
Public Sub Data_Display3()
    ...
    sValue(3) = Format(dtInput(0).Value, "yyyymm")
    sValue(4) = Left(cboInput(0).Text, 2)
    
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_05013_03", sValue(), Err_Num, Err_Dec)
    ...
    Do While Not RS01.EOF
        ...
        spdView(2).Col = 1
        spdView(2).Text = RS01!일자 & ""
        spdView(2).Col = 2
        spdView(2).Text = RS01!수량 & ""
