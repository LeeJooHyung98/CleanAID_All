...
Begin VB.Form P_04011_A_OLD 
   ...
   Begin Threed.SSPanel panMain 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         SpreadDesigner  =   "P_04011_A_OLD.frx":058A
         AppearanceStyle =   0
      End
   ...
   End
End
Attribute VB_Name = "P_04011_A_OLD"
...
Private Sub Form_Load()
    ...
    sValue(2) = Mid(cboInput(0).Text, 2, 6)
