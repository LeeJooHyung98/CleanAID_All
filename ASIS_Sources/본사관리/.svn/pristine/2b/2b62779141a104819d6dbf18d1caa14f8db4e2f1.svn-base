...
Begin VB.Form P_04009_R 
   Caption         =   "[전사업장]기간별 운동화 매출현황"
   ClientHeight    =   9735
   ClientLeft      =   1545
   ClientTop       =   3600
   ClientWidth     =   16155
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_04009_R.frx":063C
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_04009_R.frx":083E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   13
         SpreadDesigner  =   "P_04009_R.frx":3710
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_04009_R"
...
Private Sub Data_Display()
    ...
    If HeadOffice = MASTER_OFFICE_CODE Then
        ...
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecProMaster("SP_04009_00", sValue(), Err_Num, Err_Dec)
    Else
        Set RS01 = New ADODB.Recordset
    ...
    With spdView
        ...
        Do Until RS01.EOF
            ...
            .Col = 11: .Text = RS01!운동화건수 & ""                 '10
            .Col = 12: .Text = RS01!운동화금액 & ""                 '11
            .Col = 13: .Text = ""                  '12
            ...
            txtNum(6).Value = txtNum(6).Value + RS01!운동화금액
            txtNum(7).Value = txtNum(6).Value + RS01!운동화건수
...
'            .Col = 11:   .Text = RS01!운동화수량
'            txtInput(5).Text = txtInput(5).Text + RS01!운동화수량
'            .Col = 12:   .Text = RS01!운동화금액
'            txtInput(4).Text = txtInput(4).Text + RS01!운동화금액
'            .Col = 13:   .Text = RS01!운동화마진
'            RS01.MoveNext
'        Next i
'        .Redraw = True
'    End With
