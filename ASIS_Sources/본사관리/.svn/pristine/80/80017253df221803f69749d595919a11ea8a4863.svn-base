...
Begin VB.Form P_01090 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_01090.frx":05FC
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_01090.frx":0A64
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01090.frx":0C66
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin XtremeSuiteControls.PushButton cmdBtn 
            ...
            Enabled         =   0   'False
            Appearance      =   6
            Picture         =   "P_01090.frx":359E
         End
      End
   End
End
Attribute VB_Name = "P_01090"
...
Private Sub Form_Load()
    ...
    If P_01090_Flag = False Then
        ...
        Set RS01 = ExecPro("SP_M_01090_00", sValue(), Err_Num, Err_Dec)
...
Private Sub Data_Display()
    ...
    If HeadOffice = MASTER_OFFICE_CODE Then
        ...
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecProMaster("SP_M_01090_00", sValue(), Err_Num, Err_Dec)
    Else
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecPro("SP_M_01090_00", sValue(), Err_Num, Err_Dec)
    End If
...
Public Sub DataSave()
    ...
    For i = 1 To spdView.MaxRows
        ...
        If HeadOffice = MASTER_OFFICE_CODE Then
            ...
            Call ExecProMaster("SP_M_01090_01", sValue(), Err_Num, Err_Dec)
        Else
            Call ExecPro("SP_M_01090_01", sValue(), Err_Num, Err_Dec)
        End If
...
Public Sub DataDelete()
    If MsgBox("해당되는 데이터를 삭제하시겠습니까?", vbYesNo + vbInformation + vbDefaultButton2, "데이터 삭제") = vbYes Then
        ...
        Call ExecPro("SP_M_01090_02", sValue(), Err_Num, Err_Dec)
