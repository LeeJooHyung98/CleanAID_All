...
Begin VB.Form P_07011 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   3
         SpreadDesigner  =   "P_07011.frx":0092
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "지사 등록 (P_07011)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07011.frx":051B
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07011.frx":071D
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin XtremeSuiteControls.PushButton cmdBtn 
            ...
            Enabled         =   0   'False
            Appearance      =   6
            Picture         =   "P_07011.frx":3055
         End
      End
   End
End
Attribute VB_Name = "P_07011"
...
Private Sub Form_Load()
    ...
    If P_07011_Flag = False Then
        ...
        Set RS01 = ExecPro("SP_M_07011_00", sValue(), Err_Num, Err_Dec)
...
Public Sub DataSave()
    ...
    For I = 1 To spdView.MaxRows
        ...
        spdView.Col = 3
        sValue(3) = IIf(Left(Trim(spdView.Text), 1) = "Y", "1", "2")
        
        If Trim(sValue(0)) = "" Or Trim(sValue(1)) = "" Or Trim(sValue(2)) = "" Then
            Exit Sub
        End If
        
        Call ExecPro("SP_M_07011_01", sValue(), Err_Num, Err_Dec)
    Next I
...
'
'        Call ExecPro("SP_M_07011_02", sValue(), Err_Num, Err_Dec)
'
'        If Err_Num = 0 Then
'
