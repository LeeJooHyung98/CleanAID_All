   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   " 가맹점 요일할인 관리 (P_01005_C)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01005_C.frx":069C
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01005_C.frx":089E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         Protect         =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "P_01005_C.frx":3770
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdList 
         ...
         Protect         =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "P_01005_C.frx":3C6D
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel panCaption 
         ...
         Caption         =   " 가맹점 품목할인 현황"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01005_C.frx":42D3
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      End
      Begin FPSpreadADO.fpSpread spdView1 
         ...
         GridSolid       =   0   'False
         MaxCols         =   2
         SpreadDesigner  =   "P_01005_C.frx":4735
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdView2 
         ...
         GridSolid       =   0   'False
         MaxCols         =   6
         SpreadDesigner  =   "P_01005_C.frx":4C29
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_01005_C"
...
Private Sub Data_Display4(가맹점코드 As String, 시작일자 As String, 의류분류코드 As String, 요일 As String)
    ReDim sValue(3)
    ...
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_01005_A_01", sValue(), Err_Num, Err_Dec)
...
'
'        Set RS01 = New ADODB.Recordset
'        Set RS01 = ExecPro("SP_01004_03", sValue(), Err_Num, Err_Dec)
'
...
Private Sub 의류_Display()
    ...
    spdList.Row = spdList.ActiveRow
    spdList.Col = 3:  요일 = InStr("일월화수목금토", spdList.Text & "")
    
    spdView1.Row = spdView1.ActiveRow
    spdView1.Col = 1: 의류분류코드 = spdView1.Text & ""
    
    Call Data_Display4(가맹점코드, 시작일자, 의류분류코드, 요일)
End Sub
...
Public Sub DataSave()
    ...
    For iRow = 1 To spdView2.DataRowCnt
       ...
       '-------------------------------------------------------------------
        ...
        Call ExecPro("SP_01005_B_04", sValue(), Err_Num, Err_Dec)
