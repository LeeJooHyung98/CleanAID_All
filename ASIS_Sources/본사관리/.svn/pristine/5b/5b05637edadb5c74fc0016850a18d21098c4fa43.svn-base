...
Begin VB.Form P_04001_A 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin TeeChart.TChart TChart1 
         ...
         Top             =   5790
         Width           =   16140
         Base64          =   $"P_04001_A.frx":065C
         Begin TeeChart.ChartPageNavigator ChartPageNavigator1 
            Height          =   345
            Left            =   60
            Negotiate       =   -1  'True
            OleObjectBlob   =   "P_04001_A.frx":0DE4
            TabIndex        =   30
            Top             =   495
            Width           =   1200
         End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_04001_A.frx":0E35
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_04001_A.frx":1037
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   29
         SpreadDesigner  =   "P_04001_A.frx":3F09
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
