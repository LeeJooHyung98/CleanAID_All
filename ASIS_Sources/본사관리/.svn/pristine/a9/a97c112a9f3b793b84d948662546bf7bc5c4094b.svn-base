...
Begin VB.Form P_04032 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxCols         =   17
         MaxRows         =   10
         SpreadDesigner  =   "P_04032.frx":061C
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_04032.frx":11A2
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_04032.frx":13A4
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin XtremeSuiteControls.PushButton cmdBtn 
            ...
            Enabled         =   0   'False
            Appearance      =   6
            Picture         =   "P_04032.frx":3CDC
         End
      End
   End
End
Attribute VB_Name = "P_04032"
...
Private Sub Data_Display()
    ...
    sValue(0) = Mid(cboUser.Text, 2, 3):            If sValue(0) = "000" Then sValue(0) = "%"
