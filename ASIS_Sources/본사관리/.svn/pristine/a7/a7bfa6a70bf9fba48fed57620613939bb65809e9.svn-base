...
Begin VB.Form P_08003_04 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_08003_04.frx":05DC
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_08003_04"
...
Private Sub Form_Activate()
    ...
    Set RS01 = ExecPro("SP_08001_22", sValue(), Err_Num, Err_Dec)
...
Private Sub DataSave()
    ...
    For i = 1 To spdView.MaxRows
        ...
        If spdView.Value = True Then
            ...
            Open sDownPath & "\D" & sValue(1) & sValue(2) & ".Dat" For Output As #1
            
            Set RS01 = New ADODB.Recordset
            Set RS01 = ExecPro("SP_08001_23", sValue(), Err_Num, Err_Dec)
