...
Begin VB.Form P_SMSALL_3 
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      BorderStyle     =   1
      PaneTree        =   "P_SMSALL_003.frx":0E95
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         SpreadDesigner  =   "P_SMSALL_003.frx":0F27
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_SMSALL_003.frx":13B2
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_SMSALL_003.frx":15B4
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
