...
Begin VB.Form P_04011_A 
   Caption         =   "가맹점 월간 매출현황 (일자별)"
   ClientHeight    =   9945
   ClientLeft      =   -17400
   ClientTop       =   4005
   ClientWidth     =   16110
   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_04011_A.frx":063C
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_04011_A.frx":083E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   31
         SpreadDesigner  =   "P_04011_A.frx":3CAA
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_04011_A"
...
'
'    Call Get_가맹점리스트(cboOffice, Trim(Mid(Trim(cboInput(1)) & Space(10), 2, 4)))
...
Private Sub Data_Display()
    ...
    sValue(3) = DateAdd("d", -1, DateAdd("m", 1, Format(dtInput.Value, "yyyy-MM") & "-01"))
...
'
'            .Col = 14: .Formula = "SUM(L1:L" & .MaxRows - 1 & ") / SUM(G1:G" & .MaxRows - 1 & ")"
'            .Col = 15: .Formula = "SUM(E1:E" & .MaxRows - 1 & ") / SUM(G1:G" & .MaxRows - 1 & ")"
'            .Col = 16: .Formula = "SUM(F1:F" & .MaxRows - 1 & ") / SUM(G1:G" & .MaxRows - 1 & ")"
'
...
'            .Col = 31: .Formula = "SUM(AE1:AE" & .MaxRows - 1 & ")"
            ...
            .Col = 15: txtNum(11).Value = Val(.Value) '지사단가
        ...
        ' 누락된 요일을 설정한다.
        Call DateCheckAdd(spdView, Format(dtInput.Value, "YYYY-MM-01"), DateAdd("d", -1, DateAdd("m", 1, Format(dtInput.Value, "yyyy-MM") & "-01")))
        .Redraw = True
