...
Begin VB.Form P_07013 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_07013.frx":00F2
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07013.frx":02F4
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Caption         =   " 지사 외주 현황"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07013.frx":31C6
         Alignment       =   1
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      ...
      Begin XtremeSuiteControls.TabControl TabControl 
         ...
         Begin XtremeSuiteControls.TabControlPage TabControlPage 
            ...
            Begin FPSpreadADO.fpSpread spdViewScan 
               ...
               MaxRows         =   35
               ScrollBars      =   0
               SpreadDesigner  =   "P_07013.frx":3628
               UserResize      =   1
               Appearance      =   1
               HighlightHeaders=   1
               HighlightStyle  =   1
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   35
         ScrollBars      =   2
         SpreadDesigner  =   "P_07013.frx":43C7
         UserResize      =   1
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
...
Private Sub Data_Update()
    ...
    '------------------------------------------------------------
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_M_07013_03", sValue(), Err_Num, Err_Dec)
    ...
    Do While Not RS01.EOF
        ...
        Call ExecPro("SP_M_07013_02", sValue(), Err_Num, Err_Dec)
        If Err_Num <> 0 Then
            MyCon.RollbackTrans
            MsgBox Err_Dec
            Exit Sub
...
'    spdView.Col = 1: 가맹점코드 = spdView.Text & ""
    ...
    With spdViewScan
        ...
        For nRow = 1 To .MaxRows
            ...
            .Col = 5: sValue(2) = .Text & ""        ' OUTDATE
            .Col = 1: sValue(3) = panCaption(1).Tag & ""         ' OCNT
            .Col = 1: sValue(4) = .Text & ""        ' TAGNO
            
            .Col = 11: sValue(5) = .Text & ""        ' KIND
            .Col = 12: sValue(6) = .Text & ""        ' flag
            .Col = 13: sValue(7) = .Text & ""      ' ADDTYPE
            
            .Col = 1: sValue(8) = Format(dtInput(1).Value, "yyyy-MM-dd") & ""       ' INACTIONDATE
            
            '------------------------------------------------------------
            ' 외주 입고 등록 - SP_M_07013_04
            '------------------------------------------------------------
            Set RS01 = New ADODB.Recordset
...
Private Sub Data_Display2()
    ...
    With spdViewScan
        ...
        Do Until RS01.EOF
            ...
            .Col = 2: .Text = RS01!IGCODE & ""  '
            .Col = 3: .Text = RS01!IGDNM & ""    '
            .Col = 4: .Text = RS01!IPRICE & ""    '
            .Col = 5: .Text = RS01!OUTDATE & ""      'KEY
