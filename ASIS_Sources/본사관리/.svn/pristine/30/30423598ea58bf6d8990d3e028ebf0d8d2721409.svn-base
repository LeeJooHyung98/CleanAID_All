   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   " 외주 출고 등록 (P_07002)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07002.frx":00F2
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07002.frx":02F4
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   35
         ScrollBars      =   2
         SpreadDesigner  =   "P_07002.frx":31C6
         UserResize      =   1
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel SSPanel 
         ...
         Caption         =   " 지사 외주 현황"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_07002.frx":37B2
         Alignment       =   1
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      ...
      Begin XtremeSuiteControls.TabControl TabControl 
         ...
         Begin XtremeSuiteControls.TabControlPage TabControlPage 
            ...
            Begin FPSpreadADO.fpSpread spdViewScan 
               ...
               MaxRows         =   35
               ScrollBars      =   0
               SpreadDesigner  =   "P_07002.frx":3C14
               UserResize      =   1
               Appearance      =   1
               HighlightHeaders=   1
               HighlightStyle  =   1
            ...
            Begin XtremeSuiteControls.PushButton cmdBtn 
               ...
               EndProperty
               Appearance      =   6
               Picture         =   "P_07002.frx":425E
            End
         End
      End
   End
End
Attribute VB_Name = "P_07002"
...
Private Sub Data_Display()
    ...
    Set RS01 = ExecPro("[SP_M_07002_00]", sValue(), Err_Num, Err_Dec)
...
Private Sub Data_Update()
    ...
    '------------------------------------------------------------
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_M_07002_03", sValue(), Err_Num, Err_Dec)
    ...
    Do While Not RS01.EOF
        ...
        sValue(2) = RS01.Fields("OUTDATE")
        sValue(3) = RS01.Fields("OCNT")
        sValue(4) = RS01.Fields("TagNo")
        sValue(5) = RS01.Fields("PDANO")
        sValue(6) = RS01.Fields("kIND")
        sValue(7) = RS01.Fields("FLAG")
        sValue(8) = RS01.Fields("ADDTYPE")
        sValue(9) = RS01.Fields("SCANDT")
            
        Call ExecPro("SP_M_07002_02", sValue(), Err_Num, Err_Dec)
        If Err_Num <> 0 Then
            MyCon.RollbackTrans
            MsgBox Err_Dec
            Exit Sub
...
'    spdView.Col = 1: 가맹점코드 = spdView.Text & ""
    ...
    With spdViewScan
        ...
        For nRow = 1 To .MaxRows
            ...
            .Col = 7: sValue(0) = .Text & ""        ' OUTCD
            .Col = 8: sValue(1) = .Text & ""        ' MASTERCD
            .Col = 9: sValue(2) = .Text & ""        ' OUTDATE
            .Col = 10: sValue(3) = panCaption(1).Tag        ' OCNT
            .Col = 1: sValue(4) = .Text & ""        ' TagNo
            .Col = 6: sValue(5) = .Text & ""        ' PDANO
            .Col = 11: sValue(6) = .Text & ""       ' kIND
            .Col = 12: sValue(7) = .Text & ""       ' FLAG
            .Col = 13: sValue(8) = .Text & ""       ' ADDTYPE
            .Col = 5: sValue(9) = .Text & ""        ' SCANDT
            .Col = 1: sValue(10) = Format(dtInput(1).Value, "yyyy-MM-dd") & ""          ' OUTACTIONDATE
            
            
            
            '------------------------------------------------------------
            ' 외주 출고 등록 - SP_M_07002_04
            '------------------------------------------------------------
            Set RS01 = New ADODB.Recordset
            Set RS01 = ExecPro("SP_M_07002_04", sValue(), Err_Num, Err_Dec)
            If Err_Num <> 0 Then
                MyCon.RollbackTrans
                MsgBox Err_Dec
                Exit Sub
...
Private Sub dtInput_Change(Index As Integer)
    ...
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_M_07002_05", sValue(), Err_Num, Err_Dec)
...
Private Sub Data_Display2()
    ...
    '------------------------------------------------------------
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_M_07002_01", sValue(), Err_Num, Err_Dec)
    ...
    With spdViewScan
        ...
        Do Until RS01.EOF
            ...
            .Col = 3: .Text = RS01!의류명 & ""    '
            .Col = 4: .Text = RS01!OUTDATE & "" '
            .Col = 5: .Text = RS01!SCANDT & "" '
            .Col = 6: .Text = RS01!PDANO & ""    '
            .Col = 7: .Text = RS01!OUTCD & ""    'KEY
            .Col = 8: .Text = RS01!MASTERCD & ""    'KEY
            .Col = 9: .Text = RS01!OUTDATE & ""    'KEY
            .Col = 10: .Text = RS01!OCNT & ""    'KEY
            .Col = 11: .Text = RS01!KIND & ""    '
            .Col = 12: .Text = RS01!flag & ""    '
