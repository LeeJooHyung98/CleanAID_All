   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel panInput 
         ...
         Begin VB.Label Label1 
            AutoSize        =   -1  'True
            Caption         =   "담당자 코드: 1로 시작, 기사 코드 : 2로 시작,  CS팀 코드 0으로 시작"
            Height          =   195
            Left            =   4620
            TabIndex        =   15
            Top             =   240
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   2
         SpreadDesigner  =   "P_01002.frx":061C
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "P_01002.frx":0B33
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_01002.frx":0D35
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin XtremeSuiteControls.PushButton cmdBtn 
            ...
            Enabled         =   0   'False
            Appearance      =   6
            Picture         =   "P_01002.frx":366D
         End
      End
   End
End
Attribute VB_Name = "P_01002"
