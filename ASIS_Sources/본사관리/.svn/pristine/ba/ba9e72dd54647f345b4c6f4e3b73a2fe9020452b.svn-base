   ...
   Begin SSSplitter.SSSplitter SSSplitter 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   " 고객 미수금 조회 (P_10003)"
         PictureBackgroundStyle=   2
         PictureBackground=   "P_10003.frx":065C
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         EndProperty
         PictureBackgroundStyle=   2
         PictureBackground=   "P_10003.frx":085E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   35
         ScrollBars      =   2
         SpreadDesigner  =   "P_10003.frx":3730
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   9
         SpreadDesigner  =   "P_10003.frx":3D51
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin FPSpreadADO.fpSpread spdView 
         ...
         GridSolid       =   0   'False
         MaxCols         =   10
         SpreadDesigner  =   "P_10003.frx":44BE
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
   End
End
Attribute VB_Name = "P_10003"
...
Private Sub cmdBtn_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 6
            ...
            Call Export_Excel(P_00000.cdgExcel, spdView(2))      ' 엑셀
        Case 7: Unload Me           ' 종료
    End Select
...
Private Sub Data_Display()
    ...
    Set RS01 = ExecPro("SP_M_10003_00", sValue(), Err_Num, Err_Dec)
...
Private Sub Data_Display_Member(ByVal Col As Long, ByVal Row As Long)
    ...
    Set RS01 = New ADODB.Recordset
    Set RS01 = ExecPro("SP_M_10003_01", sValue(), Err_Num, Err_Dec)
    ...
    With spdView(1)
        ...
        Do Until RS01.EOF
            ...
            .Col = 4: .Text = Trim(RS01!미수금액) & ""
            .Col = 5: .Text = Trim(RS01!전화번호) & ""
            .Col = 6: .Text = RS01!휴대폰번호 & ""
            .Col = 7: .Text = RS01!최종이용일자 & ""
            .Col = 8: .Text = RS01!이용횟수 & ""
            .Col = 9: .Text = RS01!총접수금액 & ""
...
Private Sub Data_Display_Detail(ByVal Col As Long, ByVal Row As Long)
    ...
    If HeadOffice = MASTER_OFFICE_CODE Then
        ...
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecProMaster("SP_M_10003_02", sValue(), Err_Num, Err_Dec)
    Else
        Set RS01 = New ADODB.Recordset
        Set RS01 = ExecPro("SP_M_10003_02", sValue(), Err_Num, Err_Dec)
    End If
    ...
    With spdView(2)
        ...
        Do Until RS01.EOF
            ...
            .Col = 8: .Text = RS01!사용마일리지 & ""
            .Col = 9: .Text = RS01!쿠폰입금 & ""
            .Col = 10: .Text = RS01!미수금 & ""
