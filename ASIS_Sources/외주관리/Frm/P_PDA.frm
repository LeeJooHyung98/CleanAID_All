...
Private Sub Form_Activate()
    ...
    'txtInput(1).Text = Trim(GetIniStr("PDA", "Dir", "", sIniFile))
...
Sub PdaIniWrite()
    ...
    Call INIWrite("PDA", "Dir", txtInput(1).Text, sIniFile)
    'Call INIWrite("PDA", "WorkDate", Format(dtInput.Value, "YYYY-MM-DD"), sIniFile)
