VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} rpt일일매출현황2 
   Caption         =   "CleanAID - rpt일일매출현황2 (ActiveReport)"
   ClientHeight    =   12390
   ClientLeft      =   4065
   ClientTop       =   1005
   ClientWidth     =   15450
   ...
   _ExtentX        =   27252
   _ExtentY        =   21855
   SectionData     =   "rpt일일매출현황2.dsx":0000
End
Attribute VB_Name = "rpt일일매출현황2"
