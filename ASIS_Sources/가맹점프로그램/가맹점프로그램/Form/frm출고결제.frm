...
Begin VB.Form frm출고결제 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Caption         =   " 현금영수증 승인내역"
         PictureBackgroundStyle=   2
         PictureBackground=   "frm출고결제.frx":3086
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
      ...
      Begin FPSpreadADO.fpSpread sprCash 
         ...
         RowHeaderDisplay=   0
         ScrollBars      =   0
         SpreadDesigner  =   "frm출고결제.frx":32AC
         HighlightHeaders=   1
         HighlightStyle  =   1
      End
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            Caption         =   "받 은 금 액"
            PictureBackgroundStyle=   2
            PictureBackground=   "frm출고결제.frx":3961
            BorderWidth     =   0
            BevelOuter      =   1
            PictureAlignment=   9
            RoundedCorners  =   0   'False
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            Caption         =   "거 스 름 돈"
            PictureBackgroundStyle=   2
            PictureBackground=   "frm출고결제.frx":3CA3
            BorderWidth     =   0
            BevelOuter      =   1
            PictureAlignment=   9
            RoundedCorners  =   0   'False
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            Caption         =   "현 금 결 제"
            PictureBackgroundStyle=   2
            PictureBackground=   "frm출고결제.frx":3FE5
            BorderWidth     =   0
            BevelOuter      =   1
            PictureAlignment=   9
            RoundedCorners  =   0   'False
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            Caption         =   "카 드 결 제"
            PictureBackgroundStyle=   2
            PictureBackground=   "frm출고결제.frx":4327
            BorderWidth     =   0
            BevelOuter      =   1
            PictureAlignment=   9
            RoundedCorners  =   0   'False
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            Caption         =   "결제후 잔액"
            PictureBackgroundStyle=   2
            PictureBackground=   "frm출고결제.frx":4669
            BorderWidth     =   0
            BevelOuter      =   1
            PictureAlignment=   9
            RoundedCorners  =   0   'False
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            Caption         =   "영수증 출력"
            PictureBackgroundStyle=   2
            PictureBackground=   "frm출고결제.frx":49AB
            BorderWidth     =   0
            BevelOuter      =   1
            PictureAlignment=   9
            RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Caption         =   " 결제금액"
         PictureBackgroundStyle=   2
         PictureBackground=   "frm출고결제.frx":4CED
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         FloodShowPct    =   -1  'True
