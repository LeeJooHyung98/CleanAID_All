...
Begin VB.Form frmInternetAccept 
   BorderStyle     =   1  '단일 고정
   Caption         =   "인터넷 접수현황"
   ClientHeight    =   4605
   ClientLeft      =   9375
   ...
   Begin XtremeSuiteControls.PushButton btnAccept 
      ...
      EndProperty
      Appearance      =   6
      Picture         =   "frmInternetAccept.frx":0000
   End
   Begin FPSpreadADO.fpSpread sprGrid 
      ...
      OperationMode   =   2
      ScrollBars      =   2
      SpreadDesigner  =   "frmInternetAccept.frx":0A12
      UserResize      =   1
      VisibleCols     =   3
      HighlightHeaders=   1
      HighlightStyle  =   1
   ...
   Begin XtremeSuiteControls.PushButton btnCancel 
      ...
      EndProperty
      Appearance      =   6
      Picture         =   "frmInternetAccept.frx":1118
   End
End
Attribute VB_Name = "frmInternetAccept"
...
Private Sub btnAccept_Click()
    ...
    frm접수.btnInternet.Tag = sprGrid.Text
    
    Unload Me
End Sub

Private Sub btnCancel_Click()
    frm접수.btnInternet.Tag = ""
