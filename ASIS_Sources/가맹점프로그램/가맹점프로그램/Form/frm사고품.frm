...
Begin VB.Form frm사고품 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "frm사고품.frx":4F4D
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin VB.Image Image 
            ...
            Index           =   0
            Left            =   0
            Picture         =   "frm사고품.frx":5173
            Top             =   -15
            Width           =   765
         End
      End
      Begin FPSpreadADO.fpSpread sprGrid 
         Bindings        =   "frm사고품.frx":5D3D
         Height          =   8955
         Left            =   15
         TabIndex        =   11
         Top             =   1215
         ...
         Protect         =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frm사고품.frx":5D51
         VisibleCols     =   5
         VisibleRows     =   200
         HighlightHeaders=   1
         HighlightStyle  =   1
      ...
      Begin Threed.SSPanel SSPanel 
         ...
         Begin XtremeSuiteControls.GroupBox GroupBox 
            ...
            Begin VB.ComboBox cboInput 
               Height          =   300
               Index           =   0
               ItemData        =   "frm사고품.frx":64A8
               Left            =   1260
               List            =   "frm사고품.frx":64AA
               Locked          =   -1  'True
               TabIndex        =   62
               Text            =   "cboInput"
               Top             =   285
