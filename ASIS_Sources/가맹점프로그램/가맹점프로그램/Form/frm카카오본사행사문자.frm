...
Begin VB.Form frm카카오본사행사문자 
   ...
   Begin Threed.SSPanel pnlProg 
      ...
      PictureBackground=   "frm카카오본사행사문자.frx":0000
      BorderWidth     =   0
      BevelOuter      =   0
      BevelInner      =   2
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      BorderStyle     =   1
      PaneTree        =   "frm카카오본사행사문자.frx":0226
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "      카카오톡 본사 행사 문자"
         PictureBackgroundStyle=   2
         PictureBackground=   "frm카카오본사행사문자.frx":02F8
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.ComboBox cboView 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "frm카카오본사행사문자.frx":10E8
            Left            =   10950
            List            =   "frm카카오본사행사문자.frx":10F2
            Style           =   2  '드롭다운 목록
            TabIndex        =   42
            Top             =   60
            Visible         =   0   'False
      ...
      Begin XtremeSuiteControls.TabControl TabControl 
         ...
         Item(0).Control(1)=   "TabControlPage1"
         Begin XtremeSuiteControls.TabControlPage TabControlPage1 
            ...
            Begin XtremeSuiteControls.PushButton cmdSend 
               ...
               EndProperty
               Appearance      =   6
               Picture         =   "frm카카오본사행사문자.frx":289E
            End
            Begin VB.Label Label2 
               AutoSize        =   -1  'True
               BackStyle       =   0  '투명
               Caption         =   $"frm카카오본사행사문자.frx":2F98
               BeginProperty Font 
                  Name            =   "굴림체"
                  Size            =   9
                  Charset         =   129
         ...
         Begin XtremeSuiteControls.TabControlPage TabControlPage 
            ...
            Begin FPSpreadADO.fpSpread spdview_event 
               ...
               SpreadDesigner  =   "frm카카오본사행사문자.frx":36DA
               VisibleCols     =   2
               VisibleRows     =   50
               HighlightHeaders=   1
               HighlightStyle  =   1
            ...
            Begin XtremeSuiteControls.GroupBox grpEvent 
               ...
               Transparent     =   -1  'True
               UseVisualStyle  =   -1  'True
               Begin XtremeSuiteControls.FlatEdit txtReMsg 
                  Height          =   3420
                  Left            =   30
                  TabIndex        =   64
                  Top             =   1815
      ...
      Begin FPSpreadADO.fpSpread sprGrid 
         ...
         MaxCols         =   8
         MaxRows         =   300
         SpreadDesigner  =   "frm카카오본사행사문자.frx":3CE1
         VisibleCols     =   2
         VisibleRows     =   50
         HighlightHeaders=   1
         HighlightStyle  =   1
   ...
   End
End
Attribute VB_Name = "frm카카오본사행사문자"
...
Dim FORM_KAKAO01_ACTIVATE    As Boolean
...
Private Sub Form_Activate()
    ...
    If FORM_KAKAO01_ACTIVATE = True Then Exit Sub
    
    FORM_KAKAO01_ACTIVATE = True
...
Private Sub Form_Load()
    ...
    With spdview_event
        ...
        .MaxRows = 3
        .Col = 1
        .Row = 1: .Text = "테스트 행사문자 1"
        .Row = 2: .Text = "테스트 행사문자 2"
        .Row = 3: .Text = "테스트 행사문자 3"
        .Col = 2
        .Row = 1: .Text = "테스트 행사문자 상세내용 1"
        .Row = 2: .Text = "테스트 행사문자 상세내용 2"
        .Row = 3: .Text = "테스트 행사문자 상세내용 3"
    End With
...
Private Sub txtCount_Change(Index As Integer)
    ...
    If Index = 1 Then
        ...
        txtCount(2).Value = txtCount(0).Value - (txtCount(1).Value * KAKAO_PRICE)
        bCountFlag = True
    End If
End Sub
...
Private Function SendSMS() As Boolean
    ...
    For lRow = 1 To sprGrid.MaxRows
        ...
        If sprGrid.Value = 1 Then
            ...
            sprGrid.Col = 4
            nSendCnt = nSendCnt + 1
            Call send_Kakao_Friend(TempUserKey, sprGrid.Text, txtEventMsg.Text, txtEventMsg.Tag, grpEvent.Tag, txtReMsg.Text)
        End If
        sprGrid.Col = 1: sprGrid.Value = 0
    Next lRow
...
Private Sub frmGetEvtList()
    spdview_event.MaxRows = 0
    Dim RecordSet As ADODB.RecordSet
    Set RecordSet = GetEvtList
    While (Not RecordSet.EOF)
        With spdview_event
            .MaxRows = .MaxRows + 1
            .Row = .MaxRows
            .Col = 1: .Text = RecordSet!Title
            .Col = 2: .Text = RecordSet!msg
            .Col = 3: .Text = RecordSet!Attached_File
            .Col = 4: .Text = RecordSet!Event_Type
