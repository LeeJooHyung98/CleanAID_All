...
Public Function Get_DryPrice(ClothCode As String, Optional Internet As String = "") As Long
    Dim iPrice      As Double
    Dim sGoodsStats As String
    
    On Error GoTo ErrRtn
      
    iPrice = Get_세탁금액(ClothCode, sGoodsStats, Internet)
