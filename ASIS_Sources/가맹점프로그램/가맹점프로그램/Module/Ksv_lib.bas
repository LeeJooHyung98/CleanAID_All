Attribute VB_Name = "HAN_LIB"

Function Line_Format(Using_Form$, Print_Form$(), Print_Counter As Integer) As String
...
Function Format_N(Using_Form$, Print_Form$) As String
...
Function Format_X(Using_Form$, Print_Form$) As String
...
Function Format_D(Using_Form$, Print_Form$) As String
...
Function Format_H(Using_Form$, Print_Form$) As String
    Format_H = Hangul_Convert(Print_Form$, Len(Using_Form$))
End Function

Function Hangul_Convert(Convert$, Max_length)
...
Function Hangul_Cut(Cutting$, Length) As String
    Hangul_Cut = ""
    Character_Length = 0
...
Function Hangul_Length(Length$) As Integer
    Hangul_Length = 0
...
Function Hangul_Mid(Cutting$, Length1, length2) As String
    Hangul_Mid = ""
    Character_Length = 0
    Character_Length1 = 0
    For Loop_Index = 1 To Len(Cutting$)
