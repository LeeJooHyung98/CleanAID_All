...
Begin VB.Form frmP_03002 
   ...
   Begin Threed.SSPanel panMain 
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   36
         ScrollBars      =   0
         SpreadDesigner  =   "frmP_03002.frx":0000
         UserResize      =   1
         AppearanceStyle =   0
...
'    P_00000.crPrint.StoredProcParam(0) = Format(dtInput.Value, "YYYY-MM-DD")
