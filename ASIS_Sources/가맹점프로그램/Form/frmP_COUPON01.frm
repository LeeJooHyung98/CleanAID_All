...
Begin VB.Form frmP_COUPON01 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      BorderStyle     =   1
      PaneTree        =   "frmP_COUPON01.frx":0000
      Begin FPSpreadADO.fpSpread sprGrid 
         ...
         Protect         =   0   'False
         ScrollBars      =   2
         SpreadDesigner  =   "frmP_COUPON01.frx":0092
         VisibleCols     =   2
         VisibleRows     =   50
         HighlightHeaders=   1
         HighlightStyle  =   1
      ...
      Begin FPSpreadADO.fpSpread sprGrid 
         ...
         MoveActiveOnFocus=   0   'False
         Protect         =   0   'False
         SpreadDesigner  =   "frmP_COUPON01.frx":07B0
         VisibleCols     =   2
         VisibleRows     =   50
         HighlightHeaders=   1
         HighlightStyle  =   1
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin XtremeSuiteControls.PushButton cmdList 
            ...
            Caption         =   " 조회(&F)"
            Appearance      =   6
            Picture         =   "frmP_COUPON01.frx":0F5B
         End
         Begin XtremeSuiteControls.PushButton cmdBtn 
            ...
            Caption         =   " 엑셀(&E)"
            Appearance      =   6
            Picture         =   "frmP_COUPON01.frx":1655
         End
         Begin XtremeSuiteControls.PushButton cmdBtn 
            Height          =   750
            Index           =   5
            ...
            ForeColor       =   0
            Appearance      =   6
            Picture         =   "frmP_COUPON01.frx":1DCF
         End
         Begin XtremeSuiteControls.PushButton cmdPrint 
            ...
            Caption         =   " 출력(&P)"
            Appearance      =   6
            Picture         =   "frmP_COUPON01.frx":2E61
         End
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackground=   "frmP_COUPON01.frx":355B
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
         ...
         Begin VB.Image Image1 
            Height          =   240
            Left            =   60
            Picture         =   "frmP_COUPON01.frx":39BD
            Top             =   60
            Width           =   240
         End
      End
   End
End
Attribute VB_Name = "frmP_COUPON01"
...
Private Sub GetData_View()
    ...
    Query = Query & " WHERE 대리점코드 = '" & 가맹점정보.가맹점코드 & "' "
