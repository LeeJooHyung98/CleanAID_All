...
Begin VB.Form frm카카오행사문자 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         Caption         =   "      카카오 행사 문자"
         PictureBackgroundStyle=   2
         PictureBackground=   "frm카카오행사문자.frx":02D8
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.ComboBox cboView 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "frm카카오행사문자.frx":10C8
            Left            =   1050
            List            =   "frm카카오행사문자.frx":10D2
            Style           =   2  '드롭다운 목록
            TabIndex        =   94
            Top             =   30
            Width           =   3165
      ...
      Begin FPSpreadADO.fpSpread sprGrid 
         ...
         SpreadDesigner  =   "frm카카오행사문자.frx":2F78
         VisibleCols     =   2
         VisibleRows     =   50
         HighlightHeaders=   1
         HighlightStyle  =   1
      ...
      Begin XtremeSuiteControls.TabControl TabControl 
         ...
         Begin XtremeSuiteControls.TabControlPage TabControlPage 
            ...
            Begin VB.Label Label2 
               ...
               Left            =   2190
               TabIndex        =   104
               ToolTipText     =   $"frm카카오행사문자.frx":4CFD6
               Top             =   5730
               Width           =   4680
            End
            Begin VB.Line Line1 
