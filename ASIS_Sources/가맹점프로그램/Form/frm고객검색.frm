...
Begin VB.Form frm고객검색 
   ...
   Begin SSSplitter.SSSplitter SSSplitter1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         End
         Begin VB.Label Label1 
            Caption         =   "보관증이 없는 고객님의 의류는 등록된 전화번호로"
            BeginProperty Font 
               Name            =   "굴림"
               Size            =   15.75
               Charset         =   129
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         PictureBackground=   "frm고객검색.frx":103E
         BorderWidth     =   0
         BevelOuter      =   0
         Alignment       =   1
         RoundedCorners  =   0   'False
      ...
      Begin FPSpreadADO.fpSpread spdView 
         ...
         MaxRows         =   5
         ScrollBars      =   2
         SpreadDesigner  =   "frm고객검색.frx":1E2E
         HighlightHeaders=   1
         HighlightStyle  =   1
         ScrollBarStyle  =   2
      End
...
Private Sub spdView_DblClick(ByVal Col As Long, ByVal Row As Long)
    ...
    고객코드 = Get_SpreadText(spdView, Row, 5) & ""
    
    tempStr = Get_고객정보(고객코드)
